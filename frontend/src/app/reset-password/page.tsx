...
import { Lock, AlertTriangle, CheckCircle2, Hexagon, EyeOff, Eye } from 'lucide-react';
      ...
      >
        <div className="text-center mb-10 flex flex-col items-center">
          ...
          <p className="text-white/40 text-[13px] mt-2 font-medium">
            {email ? `Redefinindo senha para ${email}` : 'Crie uma nova senha de acesso.'}
          </p>
        </div>
          ...
          <AnimatePresence mode="wait">
            {success ? (
              ...
              >
                ...
                <h3 className="text-white font-bold mb-2">Senha Alterada!</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-widest text-white/40 mb-2">Nova Senha</label>
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full input-premium rounded-xl pl-11 pr-10 py-3 text-[13px] text-white placeholder:text-white/20"
                      required
                    />
                    <button 
                      type="button" 
