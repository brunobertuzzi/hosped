...
import { 
  ...
  Users, Wrench, Settings, DollarSign, LayoutDashboard, CalendarDays, Landmark, Sparkles
} from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen text-white flex font-sans overflow-hidden antialiased transition-colors duration-500" style={{ backgroundColor: 'var(--brand-bg)' }}>
      ...
      <div className="py-5 pl-5 z-20 flex shrink-0">
        <aside className="w-64 glass-card border border-white/5 rounded-[24px] flex flex-col justify-between p-5 overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        {/* Topbar Superior */}
        <header className="h-[88px] flex items-center justify-between px-10 sticky top-0 z-30 shrink-0 bg-black/40 backdrop-blur-xl border-b border-white/[0.02]">
          <div className="flex items-center gap-3 bg-white/[0.03] hover:bg-white/[0.05] border border-white/5 py-1.5 px-3 rounded-xl transition-colors">
            ...
            <div className="flex flex-col">
              ...
              <select 
                ...
                className="bg-transparent text-[13px] font-bold text-white/80 outline-none cursor-pointer border-none appearance-none hover:text-white transition-colors w-48 truncate"
              >
                {branches.map(b => (
        ...
        {/* View da Rota Ativa */}
        <main className="flex-1 overflow-y-auto px-10 pb-10 relative z-0">
